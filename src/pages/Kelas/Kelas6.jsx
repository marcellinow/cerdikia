...
export default function Pembelajaran() {
  const subjects = [
    {
      id: 1,
      name: "Pendidikan Pancasila dan Kewarganegaraan 6 SD",
      image: PPKN,
    ...
    {
      id: 4,
      name: "Pendidikan Jasmani, Olahraga, dan Kesehatan 6 SD",
      image: PJOK,
      ...
      <div className="pembelajaran-container">
        ...
        <main className="pembelajaran-main">
          <div className="pembelajaran-header">
            <h1 className="pembelajaran-title">Kelas 6</h1>
